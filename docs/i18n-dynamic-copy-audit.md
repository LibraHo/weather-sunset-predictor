...
| Utilities | `LocationName.js`, `QualityLevels.js` | Chinese municipality aliases and canonical zh-CN quality labels are product data, not standalone UI copy. | Keep the canonical data tracked here; rendered labels continue to flow through locale-aware surfaces. |
