...
Page({
  data: {
    ...
    formationFactors: [
      ...
      { title: '云厚修正', subtitle: '画布修正前分 × 30% × 云厚压力', desc: '云厚不再使用 -28 或 24 这类固定扣分上限；厚云证据、净证据、散射占比和水汽指数会合成 0-1 压力，只按当前画布能力的比例折损。' },
      ...
      { title: '空气显色', subtitle: '修正或衰减', desc: '能见度、湿度、雨后状态和空气颗粒只改变显色质量：显色好时最多约 +9 分，显色差时按比例压低，避免固定扣分打穿弱晚霞。' },
    ...
    calculationSteps: [
      ...
      { title: '3. 云厚比例折损', formula: 'thicknessPenalty = canvasBeforeThickness × 0.30 × thicknessPressure', desc: 'thicknessPressure 由厚云证据、net、散射占比、水汽指数合成；高云载体只给小缓冲，不会把高散射和高水汽风险洗掉。' },
      ...
      { title: '6. 最终显示分', formula: 'score = clamp(carrier × gate + renderingAdjustment, 0, 100)', desc: '最终还会按状态校准：无火烧云 <40，轻微霞光 <60；几何不可行、厚云、湿灰幕、雨低云会进一步封顶。' }
    ],
    changelog: [
