...
Page({
  data: {
    ...
    heroEyebrow: '霞客方法',
    heroTitle: '火烧云计算方法',
    heroCopy: '霞客综合天空画布、太阳方向光路、空气显色和坏天气限制；云厚由直射、漫射、水汽、低云和开口证据共同判断。',
    scoreBands: [
    ...
    formationFactors: [
      { title: '云层载体', subtitle: '中高云决定上限', desc: '高云和中云像天空画布，最容易被低角度阳光染出红橙色；低云更多是遮挡因素。云厚不会只看水汽，而是结合直射、漫射、低云和太阳方向开口。' },
    ...
    changelog: [
      { date: '2026-05-18', title: '云厚证据评分 v1', summary: '云厚由直射、漫射、水汽、低云、天气码和太阳方向开口共同判断，偏厚但证据不足时连续温和压分。' },
  ...
  applySectionMode(options = {}) {
    ...
    this.setData({
      ...
      heroCopy: apiOnly
        ...
        : '霞客综合天空画布、太阳方向光路、空气显色和坏天气限制；云厚由直射、漫射、水汽、低云和开口证据共同判断。'
    });
  },
