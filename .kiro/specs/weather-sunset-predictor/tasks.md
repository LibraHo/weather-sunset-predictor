...
- [ ] 46.2 头部摘要重构：展示朝霞/晚霞类型、今日/明日/日期、分数、质量等级、`日出/日落 HH:mm`、最佳观赏窗口；确认全部使用地点 IANA 时区。
