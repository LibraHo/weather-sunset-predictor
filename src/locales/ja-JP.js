...
apiAccess: 'API接続'
    ...
    "methodology": {
      ...
      "scorePoorDesc": "主条件が弱く、遠出は通常おすすめしない",
      "scoreSourceTitle": "マップスコアと精密地点スコアが異なる理由",
      "scoreSourceMap": "火焼け雲マップのスコアは地域傾向を見るためのものです。固定グリッド、バッチ気象データ、ラスター補間から作るため、地図は連続しますが各都市中心点の最終予測そのものではありません。",
      "scoreSourcePoint": "地点詳細ページの精密地点スコアは、入力座標ごとに単地点の天気・空気質・光路データを再取得し、その地点の日出または日没時刻に合わせて閉ループで計算します。",
      "scoreSourceWhy": "そのため小さな差は正常です。マップは近くの有望エリア探しに使い、今いる場所で出かけるかは精密地点スコアを見ます。差が大きい場合は精密地点スコアを優先してください。",
      "sections": {
        "cloudStructure": {
          "title": "1. 雲層構造",
