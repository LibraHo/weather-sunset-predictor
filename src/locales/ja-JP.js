    ...
    "analysisConclusion": {
      ...
      "ledger": {
        ...
        "details": {
          ...
          "remoteLayerCarrierCandidate": "遠方レイヤー {{score}}（高層雲 {{high}}、中層雲 {{mid}}、低層雲遮蔽 {{low}}）",
          ...
          "layerBrightness": "明るさ {{brightness}}、ゲート {{gate}}；層別キャリア {{canvas}}、visible-sector upper cloud {{visibleSector}} near {{visibleBearing}}°、低層雲の遮蔽 {{low}} / 透過 {{lowBlock}}、太陽幾何 {{solar}}、光路 {{path}}、空気 {{air}}、雲厚 {{thickness}}、直達／散乱 {{beam}}",
