...
apiAccess: 'Acceso API',
    ...
    "simulator": {
      ...
      "cloudNames": {
        "nearLowWall": "Pared baja cercana",
        "midAltocumulus": "Altocumulo medio",
        "farCirrus": "Capa de cirros lejana",
        "distantThickVeil": "Velo espeso lejano"
      },
      "time": {
...
,
      ...
      "ledger": {
        ...
        "labels": {
          ...
          "remoteLayerCarrier": "Portador remoto por capas",
        ...
        "details": {
          ...
          "remoteLayerCarrierCandidate": "capas remotas {{score}} (alta {{high}}, media {{mid}}, bloqueo bajo {{low}})",
