    ...
    "methodology": {
      ...
      changelog: {
        "latest": {
          ...
          "validation": "驗證：2026-06-02 北京無雨灰幕仍約 30；2026-06-03 北京無雨、橙紅光很美，回放約 66，落入 60-68 實況區間。"
        },
        "cloudThickness": {
          "date": "2026-05-27",
          "title": "雲厚比例折損 v2",
      ...
      "sections": {
        ...
        "finalFormula": {
          ...
          "desc": "最終分不為單個城市或日期加特殊保底，而是讓雲、光路、空氣三部分共同解釋分數。光路打開時，適度顆粒可讓橙紅更明顯；光路關閉時，同樣的顆粒只會壓灰。",
