const translations = {
  ...
  "home": {
    ...
    "methodology": {
      "title": "火燒雲計算方法",
      "intro": "目前火燒雲指數按「分層載體×各自受光 → 區域內協同 → 空間重疊協同 → 空氣顯色 → 限制校準」展示。單片強雲接近取最大值，多片低重疊且都受光的雲帶才會連續提高分數。",
      "versionLabel": "算法說明版本：2026.07.16-layer-spatial-overlap-synergy",
      "versionDesc": "中雲和高雲分別計算載體與受光；同一區域保留分層協同，不同區域按採樣重疊和方位獨立度去重協同。",
      ...
      changelog: {
        "latest": {
          "date": "2026-07-16",
          "title": "分層與空間重疊協同 v1",
          "summary": "中雲、高雲分別計算載體×受光；同一區域兩層都強時連續協同，太陽方向與同源遠程採樣先合併，不同方位雲帶按獨立度協同。降水或近雨濕幕明確時關閉協同。",
          "validation": "驗證：北京 2026-07-16 朝霞回放 79.5；11 個歷史樣本全部留在觀測區間；雨濕雲幕、稀疏雲、阻塞和沙塵反例未被誤抬。"
        },
        "layerBrightness": {
          "date": "2026-06-13",
          "title": "分層求和亮度公式 v1",
      ...
      "sections": {
        ...
        "transparency": {
          ...
          "formula": "分層分 = 載體 × 各自受光；區域分 = 主層 + 剩餘空間 × 分層協同；基礎分 = 主區域 + 剩餘空間 × 重疊感知協同"
        },
        "layerDiversity": {
          "title": "4. 空氣顯色",
        ...
        "finalFormula": {
          "title": "8. 最終分數",
          "subtitle": "Final Score · 兩級協同基礎分 × 空氣顯色",
          "desc": "最終分來自區域內分層協同和區域間重疊協同，再乘空氣顯色並經過狀態限制。不是簡單求和，也沒有 80 分硬門檻。",
          "formula": "最終分 = clamp(重疊感知協同基礎分 × 空氣顯色, 0, 100)，再經過硬否決／厚雲／灰幕校準",
          "highCloudCap": "高雲充足但光路被擋時，會先體現在受光亮度變弱。",
          "carrier": "基礎分 = 區域內分層協同 → 區域間重疊感知協同",
  ...
  "prediction": {
    ...
    "analysisConclusion": {
      ...
      "baseFormula": "基礎分 = 雲層條件 + 受光判斷",
      "baseHint": "太陽方向光路已納入雲層受光判斷",
      "canvasHint": "高雲/中雲提供主要色彩載體，適度薄霧可提供弱載體；低雲遮擋、厚高雲和灰幕會限制可用亮度",
      "lightPathHint": "太陽光是否能照到雲層",
      "finalFormula": "最終分 = 雲層基礎分 × 空氣顯色",
      "renderingHint": "雲層受光、濕度、能見度和顆粒物共同影響色彩表現",
      "aerosolHint": "適度氣溶膠增強橙紅散射，過多則發灰",
      "ledger": {
        "pts": "分",
        "whyThisScore": "為什麼是這個分數",
        "weightedFormula": "{{canvas}}×80% + {{light}}×20% = {{base}}",
        "gatedFormula": "雲層基礎分 {{base}}",
        "layerSumFormula": "雲層基礎分 {{base}}",
        "canvasPlusLightPath": "雲層基礎分",
        ...
        "details": {
          "cloudCarrier": "本地或周邊是否有可被日落染色的雲面",
          ...
          "directionalSamples": "主光路按太陽方向判斷；側向可視雲帶只作為雲層和受光參考",
          "lightPathScoreEvidence": "太陽方向光路 {{light}} 已納入雲層受光判斷",
