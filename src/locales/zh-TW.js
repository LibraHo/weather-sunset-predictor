const translations = {
  ...
  "home": {
    ...
    "methodology": {
      "title": "火燒雲計算方法",
      "intro": "目前的火燒雲指數會先判斷「有沒有可顯色載體」，再把太陽方向光路併入受光亮度，最後用空氣顯色條件修正。光路打開且暖霾可散射時可以保留觀察價值，但正在下雨或近雨濕幕明顯時不抬分。",
      "versionLabel": "算法版本：2026.06.13-rain-veto-warm-haze-v1",
      "versionDesc": "本版使用「Σ(分層載體 × 分層受光亮度) × 空氣顯色」。受光亮度基於低／中／高三層雲、太陽幾何、太陽方向通路、AOD／水汽、直射／散射和雲厚證據估算；光路打開、太陽方向高雲強且暖霾可散射時，只在無當前降雨和無明顯近雨濕幕時保留中燒區間。",
      ...
      changelog: {
        "latest": {
          "date": "2026-06-13",
          "title": "分層亮度 + 雨天暖霾否決",
          "summary": "最終分使用 Σ(分層載體 × 分層受光亮度) × 空氣顯色；光路打開、太陽方向高雲強且暖霾可散射時，也必須先通過當前降雨和近雨濕幕檢查。",
          "validation": "驗證：2026-06-13 北京日落維持 18.4 低分；當前小雨、近 6 小時降雨和近雨濕幕會阻止暖霾保底。"
        },
        "grayVeilDirectional": {
          "date": "2026-06-06",
      ...
      "sections": {
        ...
        "finalFormula": {
          ...
          "statusCaps": "顯示分還會按狀態校準：無火燒雲低於 40，輕微霞光低於 60；幾何不可行、厚雲、灰幕和雨低雲會進一步封頂；當前降雨或近雨濕幕不允許暖霾保底"
        }
      }
    }
  },
