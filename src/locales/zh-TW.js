const translations = {
  ...
  "home": {
    ...
    "methodology": {
      "title": "火燒雲計算方法",
      "intro": "目前的火燒雲指數會先判斷「有沒有可顯色載體」，再把太陽方向光路併入受光亮度，最後用空氣顯色條件修正。光路打開且暖霾可散射時會保留中燒觀察價值，但雨天硬阻斷不抬分。",
      "versionLabel": "算法版本：2026.06.13-warm-haze-mid-glow-v1",
      "versionDesc": "本版使用「Σ(分層載體 × 分層受光亮度) × 空氣顯色」。受光亮度基於低／中／高三層雲、太陽幾何、太陽方向通路、AOD／水汽、直射／散射和雲厚證據估算；光路打開、太陽方向高雲強且暖霾可散射時，保留中燒區間，雨天硬阻斷不保底。",
      ...
      changelog: {
        "latest": {
          "date": "2026-06-13",
          "title": "分層亮度 + 暖霾中燒校準",
          "summary": "最終分使用 Σ(分層載體 × 分層受光亮度) × 空氣顯色；光路打開、太陽方向高雲強且暖霾可散射時，保留中燒觀察價值；雨天 hard block 不會被保底抬分。",
          "validation": "驗證：2026-06-13 北京日落從 18.4 回放到 40.9；同樣樣本改為正在下雨時，暖霾保底不生效。"
        },
        "grayVeilDirectional": {
          "date": "2026-06-06",
      ...
      "sections": {
        ...
        "finalFormula": {
          ...
          "desc": "最終分不為單個城市或日期加特殊抬分，而是先看雲載體，再把光路併入受光亮度，最後由空氣顯色修正。光路打開時，適度顆粒可讓橙紅更明顯；但若雲層實際亮度弱，只保留到中燒區間，不抬成高分。",
          "formula": "最終分 = clamp(Σ(分層載體 × 分層受光亮度) × 空氣顯色, 0, 100)，再經過硬否決／厚雲／灰幕校準",
          "highCloudCap": "高雲充足但光路被擋時，會先體現在受光亮度變弱。",
          "carrier": "載體分 = max(雲層畫布分, 氣溶膠弱載體分, 太陽方向雲幕載體分)",
          ...
          "statusCaps": "顯示分還會按狀態校準：無火燒雲低於 40，輕微霞光低於 60；幾何不可行、厚雲、灰幕和雨低雲會進一步封頂；雨天 hard block 不允許暖霾保底"
        }
      }
    }
  },
    ...
    "analysisConclusion": {
      ...
      "ledger": {
        ...
        "details": {
          ...
          "grayVeilAirRendering": "滿鋪中高雲疊加偏髒空氣：雲載體 {{carrier}} × 日落光路 {{path}} × 灰幕顯色 {{air}}",
          "lightPath": "陽光是否能照到雲層",
