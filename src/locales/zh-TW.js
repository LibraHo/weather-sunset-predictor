    ...
    "methodology": {
      ...
      "sections": {
        "cloudStructure": {
          ...
          "formula": "中高雲畫布量 = 高雲×0.75 + 中雲×0.45；畫布基礎分：≤10→10，10–30→40–70，30–70→70–100，70–100→70–50，>100→43；再乘低雲／陰天懲罰，並加上有限高雲 bonus",
        ...
        "lightPath": {
          ...
          "formula": "遮擋機率 = 1 - Π(1 - 加權block)；光路分 = 100×(1-遮擋機率)×低雲權重修正×太陽方向走廊修正"
        },
        "transparency": {
          "title": "3. 大氣透明度",
        ...
        thickHighCloudPenalty: {
          ...
          formula: '氣溶膠激活 = rawAerosolScore × clamp((光路分-45)/35, 0, 1)；載體分 = max(雲層畫布分, 氣溶膠激活分)'
        },
        "precipPenalty": {
          "title": "6. 降水懲罰係數",
