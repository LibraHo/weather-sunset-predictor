const translations = {
  ...
  "home": {
    ...
    "methodology": {
      ...
      "sections": {
        ...
        "finalFormula": {
          "title": "8. 最終分數",
          "subtitle": "Final Score · 雲載體 × 日落光路 × 受光亮度 × 空氣顯色",
          "desc": "最終分不為單個城市或日期加特殊抬分，而是讓雲、光路、亮度和空氣共同解釋分數。光路打開時，適度顆粒可讓橙紅更明顯；但如果雲層實際亮度弱，同樣會被保守壓分。",
          "formula": "最終分 = clamp(雲載體 × 日落光路 × 受光亮度 × 空氣顯色, 0, 100)，再經過硬否決／厚雲／灰幕校準",
  ...
  "prediction": {
    ...
    "analysisConclusion": {
      ...
      "baseFormula": "基礎分 = 載體 × 光路門控 × 受光亮度",
      "baseHint": "太陽方向光路和受光亮度共同約束後的載體基礎分",
      "canvasHint": "高雲/中雲提供主要色彩載體，適度薄霧可提供弱載體；低雲遮擋、厚高雲和灰幕會限制可用亮度",
      "lightPathHint": "太陽光是否能照到雲層",
      "finalFormula": "最終分 = 雲載體 × 日落光路 × 受光亮度 × 空氣顯色",
