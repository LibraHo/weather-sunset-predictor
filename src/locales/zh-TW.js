const translations = {
  ...
  "home": {
    ...
    "methodology": {
      ...
      "versionDesc": "本版繼續使用「雲載體 × 日落光路 × 空氣顯色」，但會區分開口暖散射、滿鋪灰幕和太陽方向中雲帶：適度顆粒只有在雲幕不灰、光路通暢時加分；滿鋪中高雲疊加偏髒空氣會連續壓低顯色。",
      ...
      "sections": {
        ...
        thickHighCloudPenalty: {
          ...
          desc: '算法先求「能顯色的載體」，再用日落光路和空氣顯色決定它能發揮多少。太陽方向中雲帶會按強度連續參與評分；氣溶膠只有在光路打開且雲幕不灰時參與暖色散射。',
          level1: '雲層載體 = 畫布基礎分 + 雲種／雲厚／高雲有限加減分；高雲強但光路沒開，不允許直接滿分',
          level2: '雲少時仍保留氣溶膠弱載體；太陽方向中雲帶在光路通暢時可進入 50-60 檔，但不會當成頂級爆發',
          level3: '滿鋪中高雲疊加 PM/AOD 偏高會按灰幕顯色抑制處理；重霾、沙塵、能見度<8、厚雲、雨低雲仍會壓低或封頂',
          formula: 'scoringV2 = 雲載體 × 日落光路 × 空氣顯色\n先判灰幕壓力，再判開口暖散射；方向中雲帶按連續載體參與'
        },
        "precipPenalty": {
          "title": "6. 降水懲罰係數",
        ...
        "finalFormula": {
          ...
          "rendering": "空氣顯色 = 0.70–1.12；光路開且雲幕不灰時輕／中度 AOD、PM、dust 可加暖色，滿鋪灰幕則連續壓低",
