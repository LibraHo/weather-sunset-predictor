    ...
    methodology: {
      ...
      sections: {
        cloudStructure: {
          ...
          formula: '中高云画布量 = 高云×0.75 + 中云×0.45；画布基础分：≤10→10，10–30→40–70，30–70→70–100，70–100→70–50，>100→43；随后乘低云/阴天惩罚，再加有限高云 bonus',
        ...
        lightPath: {
          ...
          formula: '遮挡概率 = 1 - Π(1 - 加权block)；光路分 = 100×(1-遮挡概率)×低云权重修正×太阳方向走廊修正'
        },
        transparency: {
          title: '3. 大气透明度',
        ...
        thickHighCloudPenalty: {
          ...
          formula: '气溶胶激活 = rawAerosolScore × clamp((光路分-45)/35, 0, 1)；载体分 = max(云层画布分, 气溶胶激活分)'
        },
        precipPenalty: {
          title: '6. 降水惩罚系数',
