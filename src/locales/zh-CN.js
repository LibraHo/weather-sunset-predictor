...
export default {
  ...
  home: {
    ...
    methodology: {
      ...
      versionDesc: '本版使用“云载体 × 日落光路 × 受光亮度 × 空气显色”。受光亮度基于低/中/高三层云、太阳几何、太阳方向通路、AOD/水汽、直射/散射和云厚证据估算；多个压暗证据同时成立时才保守封顶。',
      ...
      changelog: {
        latest: {
          date: '2026-06-12',
          title: '分层亮度抑制 v1',
          summary: '新增 layerBrightness 诊断：高云/中云是载体，光路通只是必要条件，还要看这层云是否真的被照亮。AOD、水汽、漫射光占优、厚高云灰幕等多个压暗证据同时出现时，高分会被压到可观赏或轻微霞光区间。',
          validation: '验证：北京 2026-06-12 晚霞样本从高 60 档压到约 60；网页评分细则、文字分析和小程序算法页同步显示受光亮度。'
        },
        grayVeilDirectional: {
          date: '2026-06-06',
      ...
      sections: {
        ...
        thickHighCloudPenalty: {
          ...
          level2: 'AOD、水汽、PM10、低能见度、漫射光占优、厚高云和高云水汽灰幕是压暗证据；至少多个证据同时成立才封顶',
