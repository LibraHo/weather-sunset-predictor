...
export default {
  ...
  home: {
    ...
    methodology: {
      ...
      versionDesc: '本版使用“Σ(分层载体 × 分层受光亮度) × 空气显色”。受光亮度基于低/中/高三层云、太阳几何、太阳方向通路、直射/散射和云厚证据估算；云层没被点亮时按乘性门控直接压低最终分。',
      ...
      changelog: {
        latest: {
          date: '2026-06-13',
          title: '分层求和亮度公式 v1',
          summary: '最终分改为 Σ(分层载体 × 分层受光亮度) × 空气显色；光路继续作为受光亮度内部因子，不再作为最终分独立乘子。',
