...
export default {
  ...
  home: {
    ...
    methodology: {
      title: '火烧云计算方法',
      intro: '当前火烧云指数先判断“有没有可显色载体”，再把太阳方向光路并入受光亮度，最后用空气显色条件修正。光路打开且暖霾可散射时可以保留观察价值，但正在下雨或近雨湿幕明显时不抬分。',
      versionLabel: '算法版本：2026.06.13-rain-veto-warm-haze-v1',
      versionDesc: '本版使用“Σ(分层载体 × 分层受光亮度) × 空气显色”。受光亮度基于低/中/高三层云、太阳几何、太阳方向通路、直射/散射和云厚证据估算；光路打开、太阳方向高云强且暖霾可散射时，只在无当前降雨和无明显近雨湿幕时保留中烧区间。',
      ...
      changelog: {
        latest: {
          date: '2026-06-13',
          title: '分层亮度 + 雨天暖霾否决',
          summary: '最终分使用 Σ(分层载体 × 分层受光亮度) × 空气显色；光路打开、太阳方向高云强且暖霾可散射时，也必须先通过当前降雨和近雨湿幕检查。',
          validation: '验证：2026-06-13 北京日落维持 18.4 低分；当前小雨、近 6 小时降雨和近雨湿幕会阻止暖霾保底。'
        },
        grayVeilDirectional: {
          date: '2026-06-06',
      ...
      sections: {
        ...
        finalFormula: {
          ...
          statusCaps: '显示分还会按状态校准：无火烧云低于 40，轻微霞光低于 60；几何不可行、厚云、灰幕和雨低云会进一步封顶；当前降雨或近雨湿幕不允许暖霾保底'
        }
      }
    }
  },
