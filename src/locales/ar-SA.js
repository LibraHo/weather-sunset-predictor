...
export default {
  ...
  settings: {
    ...
    proxyMode: 'وضع عنوان الخادم الخلفي',
    proxyModeAuto: 'تلقائي (نفس المصدر)',
    proxyModeManual: 'يدوي',
    proxyModeHint: 'الوضع التلقائي يستخدم أصل الصفحة الحالية كعنوان للخادم الخلفي — مثالي للنشر على نفس النطاق. الوضع اليدوي يتيح تحديد عنوان مخصص.',
    proxyAutoUrl: 'عنوان الخادم الخلفي الحالي (تلقائي)',
    proxyAutoUrlHint: 'في الوضع التلقائي، يشارك الخادم الخلفي نفس أصل الواجهة الأمامية.',
    proxyUrl: 'عنوان الخادم الخلفي (يدوي)',
    proxyUrlPlaceholder: 'http://localhost:3000',
    proxyUrlHint: 'أدخل العنوان الكامل لخادم الوكيل الخلفي للوضع اليدوي.',
