...
apiAccess: 'الوصول إلى API'
    ...
    apiAccess: {
      ...
      authTitle: 'Authentication and quota',
      authBearer: 'Every Agent endpoint requires the header: Authorization: Bearer YOUR_TOKEN.',
      authDefaultQuota: 'New applications receive 3 calls per day by default; admins can adjust quota by use case.',
      authAudit: 'Calls log token, endpoint, status code, latency, and error code for troubleshooting and quota review.',
      requestTitle: 'Common request parameters',
      paramLocation: 'Place name; you can also use precise lat + lon coordinates.',
      paramType: 'sunrise or sunset; defaults to sunset.',
      paramDate: 'today, tomorrow, or YYYY-MM-DD; defaults to today.',
      paramDetail: 'forecast accepts simple or full; full returns more weather factors and explanation objects.',
      responseTitle: 'Key response fields',
      responseScore: 'score is the 0-100 sunrise/sunset glow score; quality is poor/fair/good/excellent.',
      responseWindow: 'bestViewingWindow returns the suggested viewing time window.',
      responseExplain: 'explain returns scoreComposition, factorRelations, constraints, and a natural-language explanation.',
      errorsTitle: 'Error handling',
      errorAuth: '401 means the token is missing or invalid; 403/429 means permission or quota is insufficient.',
      errorParams: '400 usually means invalid parameters such as type/date/lat/lon/bbox.',
      errorUpstream: '502/503 means the weather source or map cache is temporarily unavailable; retry later.',
      ...
      mapSummaryDesc: 'Returns map-grid summary and top points above a threshold inside a region.',
    ...
    methodology: {
      ...
      changelog: {
        latest: {
          date: '2026-05-13',
          title: 'تحليل أربعة عوامل v1',
          summary: 'تم تجميع التحليل في حامل السحب، مسار الضوء، لون الهواء، والقيود لتقليل الملاحظات المتفرقة.',
          validation: 'التحقق: الهباء، حجب السحب المنخفضة، الضباب الرمادي، السحب السميكة والمطر توضع في العامل الصحيح؛ صيغة النقاط لم تتغير.'
        },
        aerosol: {
          date: '2026-05-12',
