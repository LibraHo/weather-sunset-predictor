...
"formationAnalysis": {
  ...
  "settings": {
    ...
    "weatherFetchModeHint": "Backend first by default; if the backend is rate-limited or times out, the frontend uses an emergency path so the page does not keep loading.",
    "weatherFetchModeBackend": "Backend closed loop only",
    "weatherFetchModeClientFallback": "Backend first, frontend fallback (default)",
