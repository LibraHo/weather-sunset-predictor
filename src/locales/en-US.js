    ...
    "methodology": {
      ...
      "sections": {
        "cloudStructure": {
          ...
          "highCloudBonus": "High-cloud bonus: when high cloud >50 and low cloud <30, add (high-50)/50×6, capped at 0-6 pts. Cloud type/thickness are additive: altostratus +4, altocumulus +6, thin cloud +5, thick cloud -28; moderately thick evidence uses a continuous modifier, about -(1-modifier)×65. Low-cloud types also reduce the light-path gate"
        },
        "lightPath": {
    ...
    "analysisConclusion": {
      ...
      "ledger": {
        ...
        "details": {
          ...
          "cloudThicknessAdjustment": "cloud thickness {{thickness}}, evidence thin {{thin}} / thick {{thick}} / net {{net}}",
