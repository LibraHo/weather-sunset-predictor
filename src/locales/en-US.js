const translations = {
  ...
  "prediction": {
    ...
    "analysisConclusion": {
      ...
      "baseFormula": "Base score = cloud condition + sunlight assessment",
      "baseHint": "Sun-direction path is included in the cloud lighting assessment",
      ...
      "finalFormula": "Final score = cloud base score × air rendering",
      "renderingHint": "Cloud lighting, humidity, visibility, and aerosols jointly affect color rendering",
      ...
      "ledger": {
        ...
        "gatedFormula": "cloud layer base score {{base}}",
        "layerSumFormula": "cloud layer base score {{base}}",
        "canvasPlusLightPath": "cloud layer base score",
        ...
        "summary": {
          ...
          "default": "{{score}} points: calculated from clouds, sunlight, and air rendering"
        },
        "weather": {
        ...
        "labels": {
          "cloudCarrier": "Cloud condition",
          "lightPath": "Path evidence",
          "layerBrightness": "Cloud lighting",
        ...
        "details": {
          "cloudCarrier": "usable sunset-color cloud area from local or nearby clouds",
          ...
          "directionalSamples": "main solar path stays strict; visible side sectors only support the cloud and sunlight assessment",
          "lightPathScoreEvidence": "sunlight-path evidence {{light}} is included in the cloud lighting assessment",
